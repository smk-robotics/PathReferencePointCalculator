...
TEST_F(PathPointFinderTest, FindNearestPointBasicTurnTest1) {
...
TEST_F(PathPointFinderTest, FindNearestPointBasicTurnTest2) {
...
TEST_F(PathPointFinderTest, FindNearestPointBasicTurnTest3) {
...
TEST_F(PathPointFinderTest, FindNearestPointBasicTurnTest4) {
...
TEST_F(PathPointFinderTest, FindNearestPointBasicTurnTest5) {
...
TEST_F(PathPointFinderTest, FindNearestPointBasicTurnTest6) {
    CarState carState(0.694117729740599f, 2.68395291409013f, 0.4886924f,	0.1f);
    GuidingPathPointFinder guidingPathPointFinder;
    PathPointFinderInterface &pathPointFinder = guidingPathPointFinder;
    EXPECT_EQ(guidingPathPointFinder.pathPointIndex(carState, mBasicTurnPath), 3);
...
TEST_F(PathPointFinderTest, FindNearestPointBasicTurnTest7) {
...
TEST_F(PathPointFinderTest, FindNearestPointBasicTurnTest8) {
...
TEST_F(PathPointFinderTest, FindNearestPointBasicTurnTest9) {
...
TEST_F(PathPointFinderTest, FindNearestPointBasicTurnTest10) {
